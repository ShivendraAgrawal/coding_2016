class Solution:
    ...
    def firstMissingPositive(self, A):
        ...
        for i,ele in enumerate(A):
            to_affect = ele
            while(to_affect > 0 and to_affect <= len_a):
                flag = True
                previous_to_affect = to_affect
                to_affect = A[to_affect-1]
                if to_affect < 0 :
                    break
                else:
                    A[previous_to_affect-1] *= -1
...
print(len(A))
print(sorted(A))
# print(A.index(1), A.index(2), A.index(3),  A.index(5))
s = Solution()
